...
public:
    ...
    // Function to record enternet usage for 24 hours for a single user
...
int main()
{
    ...
    while (true)
    {
        ...
        case '2':
            ...
            cout << "To create a NEW USER press 1:\nTo check bill status press 2:\nTo Register a new Company press 3:\nTo Update Company Charges press 4:\n";
            cin >> choice;
            ...
            case '2':
            {
                cout << "1. Update Electricity data\n2. Update Water data\n3. Update Internet data\n" << endl;
                cin >> choice;
                switch (choice)
                {
                case '1':
                ...
                case '3':
                {
                    ...
                    // Perform operations to update electricity data for the specified UID
                    // For example, you can create an InternetService object with the provided UID
                    InternetService internetService(uid_in);

                    // Update electricity usage or charges for the specified UID
                    cout << "Enter new electricity usage: ";
                    internetService.RecordInternetUsage(uid_in);

                    // After updating, register the electricity data
                    internetService.RegisterInternetData();

                    double rate = 0.15;
                    double totalCharges = internetService.CalculateTotalCharges(uid_in);
                    cout << "Total charges: " << totalCharges << " Rupees" << endl;
                    break;
                }
                default:
